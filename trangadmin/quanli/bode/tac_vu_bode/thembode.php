...
<head>
    ...
    <title>Quản Lí</title>
    <link rel="stylesheet" href="themdb.css">
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            <ul>
                <!--1-->
                <li>
                    <a href="../quanlibode.php" class="active"><span class="las la-igloo"></span><span>Quản Lý</span></a>
                </li>
                <!--3-->
                <li>
                ...
                <div class="projects">
                    <div class="card">
                        <div class="card-header">
                            <h3>Nhập Thông Tin Bộ Đề Mới</h3>
                            <div>
                                <button><span class="las la-arrow-left"></span><a href="../quanlibode.php" style = "color : white;">quay lại</a></button>
                        ...
                        <div class="card-body">
                            <form action="<?php echo $_SERVER['PHP_SELF'];?>" method="POST">
                                <table>
                                    <tr><td> Mã bộ đề </td><td> <input onKeyPress="return isNumberKey(event)" type="text" placeholder="Nhập mã bộ đề" name="mabd" required/></td></tr>
                                    <tr><td> Tên bộ đề </td><td> <input type="text" placeholder="Nhập tên bộ đề" name="tenbd" required/></td></tr>
                    ...
                    if (isset($_POST['mabd']))
                    {
                        ...
                        $sqlcmd1="INSERT INTO `bode`(`mabode`, `tenbd`) VALUES ('$mabd','$tenbd')";

                        $lenhkttrung="SELECT * FROM bode WHERE mabode = '".$mabd."'";

                            $kqkttrung = mysqli_query($conn,$lenhkttrung);
                            if($dong=mysqli_fetch_array($kqkttrung))
                            {
                                ?> <script type='text/javascript'> alert("Mã bộ đề này đã tồn tại, vui lòng nhập lại!");</script> <?php
                            }
                            else
                            {
                                if ($result1=mysqli_query($conn, $sqlcmd1))
                                {
                                    ?> <script type='text/javascript'> alert("thêm bộ đề này thành công!");
                                    window.location = "loadbode.php";
                                    </script> <?php
