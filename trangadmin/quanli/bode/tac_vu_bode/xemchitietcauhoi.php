...
<body>
    ...
    <div>
        <div class="quaylai">
        <button><a href="../quanlibode.php" style = "color : white;">quay lại</a></button>
        </div>
        <h4 style="padding-left:30px; padding-top:10px;"> Mã bộ đề : <?php echo $mabode ?></h4>
        <div class="container">
                ...
                <tr>
                    ...
                    <td>
                        <button type="submit" name="delete" class="btn-1" onclick="inthongbaoxoa()">
                            <a href="xoa1cauhoi.php?mach=<?php echo $row['mach'];?>"><i class="fa-solid fa-trash-can"></i></a>
                        </button>
                    </td>
                </tr>
            </tbody>
