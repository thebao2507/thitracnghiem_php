...
<head>
    ...
    <title>Quản Lí</title>
    <link rel="stylesheet" href="quanlidethi.css">
                ...
                <div class="projects">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div>
                                <button><a href="tac_vu_dethi/themdethi.php" style = "color : white;">thêm đề thi</a></button>
                            </div>
                        </div>

                        <div class="card-body">
                            <div class="table-responsive">
                                <?php include 'tac_vu_dethi/indanhsachdethi.php'?>
                            </div>
                        </div>
