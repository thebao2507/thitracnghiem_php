...
<body>
    <?php 
        ...
        // câu lệnh sql
        $sql = "SELECT * FROM cauhoithi WHERE made = '$made'";
        //trả về kết quả
        $result = mysqli_query($conn,$sql);
    ?>
    <div>
        <div class="quaylai">
        <button><a href="../quanlidethi.php" style = "color : white;">quay lại</a></button>
        </div>
        <h4 style="padding-left:30px; padding-top:10px;"> Mã đề thi : <?php echo $made ?></h4>
        <div class="container">
