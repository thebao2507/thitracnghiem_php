...
<head>
    ...
    <title>Quản Lí</title>
    <link rel="stylesheet" href="quanlidotthi.css">
                ...
                <div class="projects">
                    <div class="card">
                        <div class="card-header">
                            <h3>Đợt thi</h3>
                            <div>
                                <button><a href="tac_vu_dotthi/themdotthi.php" style = "color : white;">thêm đợt thi</a></button>
                            </div>
                        </div>

                        <div class="card-body">
                            <div class="table-responsive">
                                <?php include 'tac_vu_dotthi/indanhsachdotthi.php'?>
                            </div>
                        </div>
