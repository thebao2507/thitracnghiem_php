...
<head>
    ...
    <title>Quản Lí</title>
    <link rel="stylesheet" href="quanlihs.css">
                ...
                <div class="projects">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div>
                            <button><a href="tac_vu/loaddanhsachhocsinh.php" style = "color : white;">thêm danh sách học sinh</a></button>
                            <button><a href="tac_vu/them1hs.php" style = "color : white;">thêm một học sinh</a></button>
                            <button><a href="tac_vu/taomatkhauthi.php" style = "color : white;">tạo mật khẩu thi</a></button>
                            <button><a href="tac_vu/xemlichsuthi.php" style = "color : white;">Xem lịch sử thi</a></button>
                            </div>
                        </div>

                        <div class="card-body">
                            <div class="table-responsive">
                                <?php include 'tac_vu/indanhsachhocsinh.php' ?>
                            </div>
                        </div>
