...
<head>
    ...
    <title>Quản Lí</title>
    <link rel="stylesheet" href="quanlipt.css">
        ...
        <header>
            ...
            <div class="user-wrapper">
                ...
                <div>
                    ...
                    <h4>
                        <?php if(isset($_SESSION['tenadmin'])) echo $_SESSION['tenadmin'] ?>
                    </h4>
                </div>
            </div>
        </header>
                ...
                <div class="projects">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div>
                                <button><a href="tac_vu_phongthi/themphongthi.php" style = "color : white;">thêm phòng thi</a></button>
                                <button><a href="tac_vu_phongthi/xemmatkhauthi.php" style = "color : white;">Xem mật khẩu thi học sinh</a></button>
                            </div>
                        </div>

                        <div class="card-body">
                            <div class="table-responsive">
                                <?php include 'tac_vu_phongthi/indanhsachphongthi.php'?>
                            </div>
                        </div>
