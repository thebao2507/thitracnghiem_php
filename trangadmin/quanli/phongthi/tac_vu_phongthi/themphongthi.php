...
<head>
    ...
    <title>Quản Lí</title>
    <link rel="stylesheet" href="thempt.css">
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            <ul>
                <!--1-->
                <li>
                    <a href="../quanliphongthi.php" class="active"><span class="las la-igloo"></span><span>Quản Lý</span></a>
                </li>
                <!--3-->
                <li>
                ...
                <div class="projects">
                    <div class="card">
                        <div class="card-header">
                            <h3>Nhập Thông Tin phòng thi Mới</h3>
                            <div>
                                <button><span class="las la-arrow-left"></span><a href="../quanliphongthi.php" style = "color : white;">quay lại</a></button>
                        ...
                        <div class="card-body">
                            <form action="<?php echo $_SERVER['PHP_SELF'];?>" method="POST">
                                <table>
                                    <tr><td> Mã phòng thi </td><td> <input onKeyPress="return isNumberKey(event)" type="text" placeholder="Nhập mã phòng thi" name="mapt" required/></td></tr>
                                    <tr><td> Tên phòng thi </td><td> <input type="text" placeholder="Nhập tên phòng thi" name="tenpt" required/></td></tr>
                    ...
                    if (isset($_POST['mapt']))
                    {
                        ...
                        $sqlcmd1="INSERT INTO `phong`(`maphong`, `tenphong`) VALUES ('$mapt','$tenpt')";

                        $lenhkttrung="SELECT * FROM phong WHERE maphong = '".$mapt."'";

                            $kqkttrung = mysqli_query($conn,$lenhkttrung);
                            if($dong=mysqli_fetch_array($kqkttrung))
                            {
                                ?> <script type='text/javascript'> alert("Mã phòng thi này đã tồn tại, vui lòng nhập lại!");</script> <?php
                            }
                            else
                            {
                                if ($result1=mysqli_query($conn, $sqlcmd1))
                                {
                                    ?> <script type='text/javascript'> alert("thêm phòng thi này thành công!");</script> <?php
